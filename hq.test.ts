...
function from_file(filepath: string, string_query: string) {
  const string_html = _data_file(filepath);
  return query_html(string_query, string_html).toString();
}
...
Deno.test("can wrap around elements.", function () {
  const html = `<article><div id="name">St. Vincent</div>
<h1 id="artist_name">St. Vincent</h1>
<div id="artist_id">7bcbShaqKdcyjnmv4Ix8j6</div>
<div id="artist_image">
...
Deno.test("can change to <img> with different dimensions.", function () {
  let html = `<article><div id="name">St. Vincent</div>
<h1 id="artist_name">St. Vincent</h1>
<div id="artist_id">7bcbShaqKdcyjnmv4Ix8j6</div>
<div id="artist_image">
  
  <img height="50" width="50" src="https://image.url" alt="image">
...
<div id="last_album_image">
  ...
  <img height="50" width="50" src="image.jpg" alt="image">
  ...
  html = `<article><div id="name">St. Vincent</div>
<h1 id="artist_name">St. Vincent</h1>
<div id="artist_id">7bcbShaqKdcyjnmv4Ix8j6</div>
<div id="artist_image">
  
  <img height="auto" width="50" src="https://image.url" alt="image">
...
<div id="last_album_image">
  ...
  <img height="auto" width="50" src="image.jpg" alt="image">
...
<div id="artist_image">
  ...
  <img height="50%" width="auto" src="https://image.url" alt="image">
...
<div id="last_album_image">
  ...
  <img height="50%" width="auto" src="image.jpg" alt="image">
